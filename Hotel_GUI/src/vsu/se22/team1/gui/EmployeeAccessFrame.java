...
public class EmployeeAccessFrame extends JFrame {
    ...
    private JLabel allowLabel = new JLabel("Allow");
    private JLabel denyLabel = new JLabel("Deny");
    private JLabel inheritLabel = new JLabel("Inherit");
    private JButton closeButton = new JButton("Close");

    EmployeeAccessFrame(ManagerFrame parent, Employee employee) {
        this.parent = parent;
        this.employee = employee;
        setTitle("Manage Access: " + employee.toString());
