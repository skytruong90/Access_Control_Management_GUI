...
public class AreaContextMenu extends JPopupMenu {
    public AreaContextMenu(ManagerFrame parent, TreeTable table) {
        ...
        JMenuItem expand = new JMenuItem(
                expanded ? I18n.get("context-menu.area.collapse") : I18n.get("context-menu.area.expand"));
        ...
        if(selected instanceof Building || selected instanceof Suite) {
            ...
            if(selected instanceof Building) {
                add.setText(I18n.get("context-menu.area.add.suite"));
                ...
                add.setText(I18n.get("context-menu.area.add.room"));
                add.addActionListener(e -> {
