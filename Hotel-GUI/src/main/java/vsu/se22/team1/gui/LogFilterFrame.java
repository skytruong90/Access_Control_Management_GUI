...
public class LogFilterFrame extends JFrame {
    ...
    private JLabel filterByLabel = new JLabel(I18n.get("log-filter.filter-by"));
    private JComboBox<LogFilter.FilterKey> filterBy;
    private JLabel sortByLabel = new JLabel(I18n.get("log-filter.sort-by"));
    private JComboBox<LogFilter.FilterKey> sortBy;
    private JLabel dateStartLabel = new JLabel(I18n.get("log-filter.start-date"));
    private JFormattedTextField dateStart = new JFormattedTextField(DATE_FORMAT);
    private JLabel dateEndLabel = new JLabel(I18n.get("log-filter.end-date"));
    private JFormattedTextField dateEnd = new JFormattedTextField(DATE_FORMAT);
    private JLabel areaLabel = new JLabel(I18n.get("table.access-history.area"));
    private JComboBox<Area> area;
    private JLabel employeeLabel = new JLabel(I18n.get("table.access-history.employee-id"));
    private JSpinner employee = new JSpinner();
    private JLabel flagLabel = new JLabel(I18n.get("table.access-history.flag"));
    private JComboBox<AttemptFlag> flag;
    private ButtonGroup sortDirection = new ButtonGroup();
    private JRadioButton sortDirectionAscending = new JRadioButton(I18n.get("log-filter.sort.ascending"));
    private JRadioButton sortDirectionDescending = new JRadioButton(I18n.get("log-filter.sort.descending"));
    ...
    LogFilterFrame(ManagerFrame parent) {
        this.parent = parent;
        setTitle(I18n.get("log-filter.title"));
