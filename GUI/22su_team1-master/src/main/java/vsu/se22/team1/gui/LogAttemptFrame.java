...
public class LogAttemptFrame extends JFrame {
    ...
    LogAttemptFrame(ManagerFrame parent) {
        this.parent = parent;
        setTitle(I18n.get("log-attempt-frame.title"));
    ...
    private void addComponents() {
        ...
        submitButton.addActionListener(e -> {
            ...
            if(a == null) {
                JOptionPane.showMessageDialog(LogAttemptFrame.this, I18n.get("log-attempt-frame.exception.area"),
            ...
            if(flag == AttemptFlag.SECURITY_ALERT) {
                JOptionPane.showMessageDialog(parent, I18n.get("log-attempt-frame.security-alert", id),
                        I18n.get("log-attempt-frame.security-alert.title"), JOptionPane.WARNING_MESSAGE);
            }
        });
